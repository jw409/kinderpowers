...
<execution_context>
@${CLAUDE_PLUGIN_ROOT}/gsd/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @${CLAUDE_PLUGIN_ROOT}/gsd/workflows/session-report.md end-to-end.
</process>
