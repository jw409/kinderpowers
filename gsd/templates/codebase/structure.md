...
- Usage: Reference from command with `@${CLAUDE_PLUGIN_ROOT}/gsd/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/jw/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/jw/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
