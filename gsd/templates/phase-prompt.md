...
<!-- For checkpoint task examples and patterns, see @${CLAUDE_PLUGIN_ROOT}/gsd/references/checkpoints.md -->
...
See `${CLAUDE_PLUGIN_ROOT}/gsd/references/tdd.md` for TDD plan structure.
...
See `${CLAUDE_PLUGIN_ROOT}/gsd/templates/user-setup.md` for full schema and examples
...
See `${CLAUDE_PLUGIN_ROOT}/gsd/workflows/verify-phase.md` for verification logic.
