...
PHASES=$(node "${CLAUDE_PLUGIN_ROOT}/gsd/bin/gsd-tools.cjs" phases list)
...
```bash
node "${CLAUDE_PLUGIN_ROOT}/gsd/bin/gsd-tools.cjs" commit "docs(roadmap): add gap closure phases {N}-{M}" --files .planning/ROADMAP.md .planning/REQUIREMENTS.md
```
