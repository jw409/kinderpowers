...
**State B (create):**
1. Read template from `${CLAUDE_PLUGIN_ROOT}/gsd/templates/VALIDATION.md`
...
node "${CLAUDE_PLUGIN_ROOT}/gsd/bin/gsd-tools.cjs" commit "docs(phase-${PHASE}): add/update validation strategy"
```
